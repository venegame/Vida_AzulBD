...
BEGIN
    OPEN p_cursor FOR
    SELECT ID_USUARIO, ID_ROL, NOMBRE_USUARIO, APELLIDO_USUARIO, CORREO, CONTRASENIA
    FROM USUARIO;
END;
...
CREATE OR REPLACE PROCEDURE USRVIDA_AZUL.SP_OBTENER_TRANSPORTES (p_transportes OUT SYS_REFCURSOR) AS
BEGIN
