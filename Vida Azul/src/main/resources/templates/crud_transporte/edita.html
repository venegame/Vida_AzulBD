        ...
        <div class="container">
            ...
            <form action="#" class="row g-3" method="post" autocomplete="off">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="id_transporte" name="id_transporte" required autofocus>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="horario_transporte" name="horario_transporte" required>
                </div>
                ...
                <div class="col-12">
                    <a href="../transporte/listado.html" class="btn btn-secondary">Regresar</a>
